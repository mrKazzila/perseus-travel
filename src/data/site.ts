...
type SiteContent = {
  ...
  gallery: { eyebrow: string; title: string; images: { src: string; alt: string; caption: string; position?: string }[] };
...
export const content: Record<Locale, SiteContent> = {
  en: {
    ...
    setup: { eyebrow: 'Travel inventory', title: 'Perseus’s travel kit', intro: 'Everything needed for everyday life travels with him.', items: ['Carrier', 'Portable litter box', 'Scratching post', 'Toys', 'Blanket', 'Camera'] },
    ...
    gallery: {"eyebrow": "Photo album", "title": "Little moments together", "images": [{"src": "/images/cat/perseus-portrait.webp", "alt": "Perseus resting on a chair", "caption": "A moment at home", "position": "50% 45%"}, {"src": "/images/cat/perseus-forest-portrait.webp", "alt": "Perseus in a harness among forest plants", "caption": "Exploring together", "position": "50% 45%"}, {"src": "/images/cat/perseus-blanket-hideout.webp", "alt": "Perseus peeking out from under a blanket", "caption": "Under the blanket", "position": "50% 45%"}, {"src": "/images/cat/perseus-carrier-nap.webp", "alt": "Perseus sleeping inside his carrier", "caption": "A nap on the road", "position": "50% 45%"}]},
  ...
  ru: {
    ...
    setup: { eyebrow: 'Дорожный инвентарь', title: 'Дорожный набор Персея', intro: 'Всё необходимое для повседневной жизни путешествует вместе с ним.', items: ['Переноска', 'Портативный лоток', 'Когтеточка', 'Игрушки', 'Плед', 'Камера'] },
    ...
    gallery: {"eyebrow": "Фотоальбом", "title": "Маленькие моменты вместе", "images": [{"src": "/images/cat/perseus-portrait.webp", "alt": "Персей отдыхает на кресле", "caption": "Домашние мгновения", "position": "50% 45%"}, {"src": "/images/cat/perseus-forest-portrait.webp", "alt": "Персей в шлейке среди лесных растений", "caption": "Исследуем мир вместе", "position": "50% 45%"}, {"src": "/images/cat/perseus-blanket-hideout.webp", "alt": "Персей выглядывает из-под пледа", "caption": "Под пледом", "position": "50% 45%"}, {"src": "/images/cat/perseus-carrier-nap.webp", "alt": "Персей спит в переноске", "caption": "Сон в дороге", "position": "50% 45%"}]},
